...
import { FindUserQueryHandler } from "./api/v2/cqrs/queries/handlers/find-user-query.handler";
...
@Module({
  ...
  providers: [
    ...
    ...[
      ...
      // queries
      ...[FindProfileQueryHandler, FindUserQueryHandler, FindAllUsersQueryHandler, FindDetailClientUserQueryHandler],
      // validates
      ...[
